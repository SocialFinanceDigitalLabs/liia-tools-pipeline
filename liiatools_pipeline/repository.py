...
from liiatools_pipeline.jobs.ssda903 import ssda903_incoming, ssda903_reports
...
def sync():
    ...
    """
    jobs = [ssda903_incoming, ssda903_reports, external_incoming, ssda903_sufficiency]
    schedules = []
